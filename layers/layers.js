...
lyr_MindanaoWellDatabase_4.set('fieldAliases', {'Well Name': 'Well Name', 'Water District': 'Water District', 'x(y)': 'x(y)', 'y(x)': 'y(x)', 'SWL (m)': 'SWL (m)', 'PWL (m)': 'PWL (m)', 'Q (lps)': 'Q (lps)', 'Screen Depth (m)': 'Screen Depth (m)', 'Date': 'Date', });
...
lyr_MindanaoWellDatabase_4.set('fieldImages', {'Well Name': '', 'Water District': '', 'x(y)': '', 'y(x)': '', 'SWL (m)': '', 'PWL (m)': '', 'Q (lps)': '', 'Screen Depth (m)': '', 'Date': '', });
